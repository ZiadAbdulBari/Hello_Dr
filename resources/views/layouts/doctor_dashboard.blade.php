            ...
            <div class="dashboard-menu bg-info">
                ...
                <div class="text-center mt-5">
                    <div class="d-grid gap-2">
                        <a class="link-info btn btn-dark" type="button"  href="{{url('doctordashboard')}}">Home</a>
                        <a class="link-info btn btn-dark" type="button" href="{{url('doctor/history')}}">History</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDarkDropdownMenuLink">
                                <li><a class="dropdown-item" href="{{url('doctor/profile/edit')}}">Edit Profile</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
            </div>
            @yield('doctor_dashboard_content')
        </div>
    </div>
